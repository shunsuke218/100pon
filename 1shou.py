...
print ''.join(list(string)[1:len(string):2])
...
print {n: a[:1] if n in list else a[:2] for (n,a) in enumerate(string.split(' '),1)}
...
print string, cipher(string), cipher(cipher(string))
